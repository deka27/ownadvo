...
// import featuresdiagonal from "../assets/images/fd.jpg";
      ...
      >
        <div className=" 2xl:w-[1150px] xl:w-[1050px]  md:w-4/5 flex justify-center bg-customDarkBg1 pt-12 lg:pt-24 pb-8 lg:pb-20 mx-auto lg:flex-row flex-col">
          <div className="w-3/4 lg:w-1/2 flex flex-col lg:mx-unset mx-auto">
            ...
            <p className="mb-16 text-white leading-loose">
            Our comprehensive legal consultation package features a 60-minute initial consultation with a specialized attorney, strategic planning, document review, and a 30-minute follow-up session.
            </p>
            <div
