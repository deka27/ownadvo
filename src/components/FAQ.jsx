...
const FAQData = [
  {
    question: "What time are you guys open?",
    answer:
      "We are open from 10 AM to 8 PM through Monday till Sunday.",
  },
  {
        ...
        <div className="md:max-w-4xl mx-auto">
          ...
          <div className="mb-11 flex flex-wrap -m-1">
            {FAQData.map((item, index) => (
              <div key={item} className="w-full p-1">
                <FAQBox
                  title={item.question}
                  content={item.answer}
...
const FAQBox = ({ defaultOpen, title, content }) => {
  ...
  return (
    <div
      className="py-2 sm:py-6 px-3 sm:px-8  rounded-3xl bg-customDarkBg3 custom-border-gray-darker mb-4 relative hover:bg-customDarkBg3Hover cursor-pointer"
